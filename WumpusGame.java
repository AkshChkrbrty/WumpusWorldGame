...
public class WumpusGame extends JFrame {
       ...
       public void gameGraphics(){
        ...
        JLabel label = new JLabel(
            "<html>Press ← for Left Move<br>Press → for Right Move<br>Press ↑ for Up<br>Press ↓ for Down</html>"
        );
...
public void moveLeft() {
    ...
    if (a[pp] == 3) {
        ...
        go.add(new JLabel("Game Over"));
        go.add(btnNewGame, BorderLayout.SOUTH);
        go.setSize(200, 100);
        go.setVisible(true);
    }
    if (a[pp] == 5) {
    ...
    sq[newRow][newCol].add(new JLabel(new ImageIcon("player.png"))); // ✅ fixed path
...
public void moveRight() {
    ...
    sq[newRow][newCol].setBackground(Color.CYAN);
    sq[newRow][newCol].setBorder(BorderFactory.createLineBorder(Color.BLACK));
    sq[newRow][newCol].add(new JLabel(new ImageIcon("player.png")));
    if (a[pp] == 2) sq[newRow][newCol].add(new JLabel("Stench"));
    if (a[pp] == 4) sq[newRow][newCol].add(new JLabel("Breeze"));
    if (a[pp] == 6) { sq[newRow][newCol].add(new JLabel("Gold")); win--;a[pp]=7; }
    if (a[pp] == 7) { sq[newRow][newCol].add(new JLabel("Gold"));}
    if (a[pp] == 3) {
        JFrame go = new JFrame("Game Over");
        go.add(new JLabel("Game Over", SwingConstants.CENTER), BorderLayout.CENTER);
        go.add(btnNewGame, BorderLayout.SOUTH); // restart button
        go.setSize(200, 100);
...
public void hitDown(){
     ...
     if (a[pp] == 2){
       ...
       ImageIcon icon = new ImageIcon("player.png"); // replace with your image file
       JLabel imageLabel = new JLabel(icon);
       sq[0][0].add(imageLabel);
       if(a[0]==2){
       JLabel state = new JLabel("Stench");
       sq[0][0].add(state);
       }
       if(a[0]==4){
       JLabel state = new JLabel("Breeze");
       sq[0][0].add(state);
       }
       if(a[0]==6){
       JLabel state = new JLabel("Gold");
       sq[0][0].add(state);
       win--;
       }
       pp=0;
       ...
       public void checkWin() {
        ...
        winFrame.add(btnNewGame, BorderLayout.SOUTH); // allow restart
        winFrame.setSize(250, 120);
        winFrame.setLocationRelativeTo(null);
        winFrame.setVisible(true);
    }
}
/** Redraw board after killing */
